...
Kimi is a global leader in engineering solutions based in New jersey. We are currently in the development phase of advanced firmware for a new inverter module.To ensure the highest standards of safety and reliability, this project requires strict adherence to functional safety standards and a robust testing framework.

Kimi is seeking proposals from qualified engineering service providers to support our team in two key areas:
...
*   **Code Refactoring:** Refactor the existing codebase to align with Kimi specified TSC (Technical Safety Concept) Architecture.
...
*   **HIL Testing:** Conduct remote testing on Kimi HIL setup, including the execution of fault insertion tests to validate safety mechanism effectiveness.
...
6.  **Assumptions & Dependencies:** A list of any assumptions made in your proposal and any dependencies on Kimi (e.g., hardware availability, access to systems, etc.).
